...
# Fallback: read from arguments (Shortcuts sometimes does this)
...
project_filename = name_match.group(1).strip() + ".aep"
folder_path = path_match.group(1).strip()

# Path to your JSX
JSX_PATH = "/Users/mjvrmqz/Personal/Scripts/Editing Software/After Effects/Automation/Create New Project/Create New Project.jsx"
...
# Confirmation output
print("SUCCESS: new_ae_project.jsx was updated")
print("-------------------------------")
