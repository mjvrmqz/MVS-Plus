...
project_filename = name_match.group(1).strip() + ".prproj"
folder_path = path_match.group(1).strip()

# Path to your Premiere JSX
JSX_PATH = "/Users/mjvrmqz/Personal/Scripts/Editing Software/Premiere Pro/Create New Project/Create New Project.jsx"
...
# Confirmation output
print("SUCCESS: Premiere JSX was updated")
print("-------------------------------")
