function precompKeepSlot() {
    ...
    var indices = []; var earliestIn = selected[0].inPoint; var latestOut = selected[0].outPoint;
    ...
    for (var i = 1; i < indices.length; i++) { if (indices[i] < topIndex) topIndex = indices[i]; }
